...
#include "nav2_colregs_msgs/msg/polygon_object.hpp"
#include "nav2_colregs_msgs/msg/circle_object.hpp"
...
public:
   ...
   */
  nav2_colregs_msgs::msg::PolygonObject::SharedPtr getParams() const;

  /**
   * @brief Tries to update Polygon parameters
   * @return False in case of inconsistent shape
   */
  bool setParams(const nav2_colregs_msgs::msg::PolygonObject::SharedPtr params);
...
protected:
  ...
  nav2_colregs_msgs::msg::PolygonObject::SharedPtr params_;
...
public:
   ...
   */
  nav2_colregs_msgs::msg::CircleObject::SharedPtr getParams() const;

  /**
   * @brief Tries to update Circle parameters
   * @return False in case of inconsistent shape
   */
  bool setParams(const nav2_colregs_msgs::msg::CircleObject::SharedPtr params);
...
protected:
  ...
  nav2_colregs_msgs::msg::CircleObject::SharedPtr params_;

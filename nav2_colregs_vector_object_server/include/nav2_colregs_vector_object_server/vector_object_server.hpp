...
#include "nav2_colregs_msgs/srv/add_shapes.hpp"
#include "nav2_colregs_msgs/srv/remove_shapes.hpp"
#include "nav2_colregs_msgs/srv/get_shapes.hpp"
#include "nav2_util/lifecycle_node.hpp"

#include "nav2_colregs_vector_object_server/vector_object_utils.hpp"
...
protected:
  ...
  /// @brief Whether to use fixed map dimensions from config (instead of dynamic sizing)
  bool use_fixed_map_{false};
  /// @brief Fixed map width in meters
  double map_width_{0.0};
  /// @brief Fixed map height in meters
  double map_height_{0.0};
  /// @brief Fixed map origin X in world coordinates
  ...
  rclcpp::Service<nav2_colregs_msgs::srv::GetShapes>::SharedPtr get_shapes_service_;
  /// @brief RemoveShapes service
  rclcpp::Service<nav2_colregs_msgs::srv::RemoveShapes>::SharedPtr remove_shapes_service_;

...
"""COLREGS simulation launch — all-in-one Gazebo + Nav2 bringup for TB3."""
...
def generate_launch_description():
    ...
    # Spawn robot in Gazebo using conda's spawn_tb3.launch.py
    ...
    # Add custom models and parent directory to GZ_SIM_RESOURCE_PATH
    # (Mirrors spawn_tb3.launch.py pattern — both paths needed for
    #  model://turtlebot3_world and model://turtlebot3_model resolution)
    ...
    # Set GZ_SIM_RESOURCE_PATH before Gazebo starts
    ld.add_action(set_env_models)
    ld.add_action(set_env_models_parent)

    # Simulation pipeline — order must be:
    #   xacro → gz_robot (env vars from spawn_tb3) → gz server/client

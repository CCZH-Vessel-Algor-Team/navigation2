...
def generate_launch_description():
    ...
    vector_keepout_params_file = LaunchConfiguration('vector_keepout_params_file')
    ...
    declare_params_file = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            bringup_dir, 'params', 'nav2_colregs_params_behavior_validation.yaml'))
    declare_vector_keepout_params_file = DeclareLaunchArgument(
        'vector_keepout_params_file',
        default_value=os.path.join(
            bringup_dir, 'params', 'vector_object_server_params_behavior_validation.yaml'))
    ...
    ld.add_action(declare_vector_keepout_params_file)
